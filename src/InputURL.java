...
public class InputURL {
	...
	//	System.out.println("one");
		Elements title2 = Capture.fetchPageData("http://scholar.google.com.cn/citations?hl=zh-CN&user=n1zDCkQAAAAJ&pagesize=100&view_op=list_works&cstart=100", 1).select("tr td a.cit-dark-large-link");
	//	System.out.println("two");
		Startfunc.Makedata(title1, title2);
    //    System.out.println("three");
    	Document target = Capture.fetchPageData("http://keg.cs.tsinghua.edu.cn/jietang/publication_list.html", 2);
